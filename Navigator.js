      ...
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Home" screenOptions={({navigation}) => ({
          ...
          options={({navigation}) => ({
            ...
            headerLeft: () => (
                <View style={{marginLeft: 5}}>
                  <Icon
                name='menu' style={{marginLeft: 15}} onPress={() => toggleDrawer(navigation)}/>
                </View>
              ),
            headerRight: () => <Pressable onPress={() => logout(navigation)} ><Text style={{color:'black', marginRight: 10}}>Logout</Text></Pressable>
          })} 
          />
          ...
          <Stack.Screen name="MyProfile" component={MyProfile} options={{ title: 'My Profile'}}
            ...
            <Stack.Screen name="Report" component={ExpenseReport} options={{ title: 'Analytics'}}
            options={({navigation}) => ({
              title: 'Analytics',
                headerLeft: () => (
                    <View style={{marginLeft: 5}}>
          ...
          <Stack.Screen name="AddRecord" component={AddRecord} options={{ title: 'Add a Record'}}
            ...
            <Stack.Screen name="Navigation" component={Navigation} options={({navigation: { goBack }}) => ({
            headerLeft: () => (
                <View style={{marginLeft: 5}}>
                  <Icon
                name='menu' style={{marginLeft: 15}} onPress={() => goBack()}/>
                </View>
              )
          })} />
        </Stack.Navigator>
