        ...
        <ScrollView contentContainerStyle={styles.pageScrollContainer}>
            <View style={styles.pageViewContainer}>
                ...
                <View style={styles.userDetails}>
                    <Image style={styles.userProfilePicture} resizeMode='cover' borderRadius={50} source={{uri: `${user.photoProfile}`}}/>
                    <View style={styles.userDetailTexts}>
                        <Text style={styles.userName}>{user.fullName}</Text>
                        <Text style={styles.userBalance}>Balance: <NumberFormat value={user.balance} decimalScale={0} displayType={'text'} thousandSeparator={true} prefix={'Rp '} renderText={formattedValue => <Text style={styles.userBalanceText}>{formattedValue}</Text>} /></Text>
